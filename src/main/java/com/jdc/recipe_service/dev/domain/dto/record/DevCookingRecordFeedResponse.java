...
/** Dev V3 요리 기록 피드 응답 (날짜별 그룹, 무한스크롤). */
@Getter
@Builder
@Schema(description = "Dev V3 요리 기록 피드 응답 (날짜별 그룹, 무한스크롤)")
public class DevCookingRecordFeedResponse {
    ...
    public static class DailyGroup {
        ...
        private List<DevCookingRecordSummaryDto> records;
    }
}
